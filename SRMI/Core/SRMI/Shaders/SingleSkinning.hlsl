...
void main(uint3 vThreadID: SV_DispatchThreadID) {
    ...
    float4 pose_0 = (blend.weight.x * skinning[blend.index.x + offset][0].xyzw + blend.weight.y * skinning[blend.index.y + offset][0].xyzw + blend.weight.z * skinning[blend.index.z + offset][0].xyzw + blend.weight.w * skinning[blend.index.w + offset][0].xyzw);
    float4 pose_1 = (blend.weight.x * skinning[blend.index.x + offset][1].xyzw + blend.weight.y * skinning[blend.index.y + offset][1].xyzw + blend.weight.z * skinning[blend.index.z + offset][1].xyzw + blend.weight.w * skinning[blend.index.w + offset][1].xyzw);
    float4 pose_2 = (blend.weight.x * skinning[blend.index.x + offset][2].xyzw + blend.weight.y * skinning[blend.index.y + offset][2].xyzw + blend.weight.z * skinning[blend.index.z + offset][2].xyzw + blend.weight.w * skinning[blend.index.w + offset][2].xyzw);
